            ...
            <div className="window-header" onDoubleClick={() => onMaximize(id)}>
                ...
                <div className="window-controls">
                    ...
                    >
                        {isMaximized ? (
                            <svg width="8" height="8" viewBox="0 0 10 10">
                                <rect x="0" y="2" width="7" height="7" fill="none" stroke="currentColor" strokeWidth="1.5" rx="0.5" />
                                <rect x="3" y="0" width="7" height="7" fill="none" stroke="currentColor" strokeWidth="1.5" rx="0.5" />
                            </svg>
                        ) : (
                            <svg width="8" height="8" viewBox="0 0 10 10">
                                <rect x="1" y="1" width="8" height="8" fill="none" stroke="currentColor" strokeWidth="1.8" rx="0.5" />
                            </svg>
                        )}
                    </button>
                </div>
