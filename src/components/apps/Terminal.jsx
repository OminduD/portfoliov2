...
const Terminal = () => {
        ...
        if (info.type === 'user-header') {
            return (
                <span className="ff-user-line">
                    ...
                    <span className="ff-hostname">linux</span>
                </span>
            );
        }
    ...
    const renderPrompt = () => (
        <span className="omz-prompt">
            <span className="omz-segment omz-seg-user"><span className="omz-seg-text"> omindu@linux </span></span>
  ...
  Currently running \x1bHLArch Linux\x1bEND with \x1bHLKDE Plasma\x1bEND on a
  ...
  \x1bBULLET▸\x1bEND \x1bCMDOS/Desktop\x1bEND     — Arch Linux, KDE Plasma`;
                break;
            case 'contact':
...
\x1bEMERGE[ebuild   R   ]\x1bEND sys-kernel/linux-6.12.74
...
>>> Total: \x1bHL1847\x1bEND packages installed.`;
            ...
            case 'uname':
            case 'uname -a':
                output = `Linux linux \x1bHL6.12.74-1-lts\x1bEND #1 SMP PREEMPT_DYNAMIC x86_64 AMD Ryzen 5 4600H GNU/Linux`;
                break;
            case 'uptimed':
            case 'uptime':
